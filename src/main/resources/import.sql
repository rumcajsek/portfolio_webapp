...
INSERT INTO client_to_user_role(client_entity_set_id, user_role_set_id) VALUES ((SELECT cld.id FROM client_login_data cld WHERE cld.email='ania.kowalska@gmail.com'), (SELECT cur.id FROM client_user_role cur WHERE cur.name = 'ADMIN'));
INSERT INTO client_to_user_role(client_entity_set_id, user_role_set_id) VALUES ((SELECT cld.id FROM client_login_data cld WHERE cld.email='ania.kowalska@gmail.com'), (SELECT cur.id FROM client_user_role cur WHERE cur.name = 'USER'));
INSERT INTO client_to_user_role(client_entity_set_id, user_role_set_id) VALUES ((SELECT cld.id FROM client_login_data cld WHERE cld.email='martanowak@gmail.com'), (SELECT cur.id FROM client_user_role cur WHERE cur.name = 'USER'));
INSERT INTO client_to_user_role(client_entity_set_id, user_role_set_id) VALUES ((SELECT cld.id FROM client_login_data cld WHERE cld.email='anikacz@gmail.com'), (SELECT cur.id FROM client_user_role cur WHERE cur.name = 'USER'));
